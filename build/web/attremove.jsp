<%-- 
    Document   : tudoremove
    Created on : 04/04/2022, 15:49:06
    Author     : WebFullStack
--%>
...
<body>
    ...
    <div class="content-card">
        <div class="card-control">
            ...
            <form method="post" action="remover.jsp">
            <input type="text" placeholder="TELEFONE" class="remove" id="remove" name="remove">
            <div>
                <input type="submit" value="Remover" name="btn"></input>
            </div>
            </form>
